...
<template>
  ...
  <div class="container pt-lg">
    ...
    <div class="flex justify-end">
      <button id="mode" class="btn-primary">Toggle Theme</button>
    </div>
    ...
    <div class="flex mb-lg">
      <button class="btn-primary mr-6">Primary</button>
      <button class="btn-secondary">Secondary</button>
    </div>

    <div class="flex">
      <button class="btn-primary btn-small mr-6">Small Primary</button>
      <button class="btn-secondary btn-small">Small Secondary</button>
    </div>
      ...
      <div class="row gap-8">
        ...
        <div class="col-12 col-6@md col-4@lg">
          <div class="form-element">
            ...
            <input class="form-field" type="date" required="" placeholder="" />
          </div>
        </div>
        <div class="col-12 col-6@md col-4@lg">
          <div class="form-element">
